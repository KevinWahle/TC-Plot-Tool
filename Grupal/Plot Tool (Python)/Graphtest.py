...
curves =    [Curve(nombre="Montecarlo", Hnum="", Hden="", path='inputExamples/montecarlo-simulacion.txt', modo=0),
            ...
            Curve(nombre="Teórica", Hnum="1,0,1", Hden="1,1,1", path='', modo=0)
            ]
exitaciones = [Excitation(name ="escalón", type=0, amp=0, freq=0, freqType='F', duty=1)]

graphCurves(curves=curves, axes=axis, exitaciones = exitaciones)
