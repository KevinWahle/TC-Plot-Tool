...
"max-width:160px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Elemento 3"))
        item = self.listWidget.item(3)
        item.setText(_translate("MainWindow", "Elemento 4"))
        item = self.listWidget.item(4)
        item.setText(_translate("MainWindow", "Elemento 5"))
        item = self.listWidget.item(5)
        item.setText(_translate("MainWindow", "Elemento 6"))
