...
class H_Window_design(object):
    def setupUi(self, Dialog):
        ...
        self.scaleLinRbtn = QtWidgets.QRadioButton(Dialog)
        self.scaleLinRbtn.setObjectName("scaleLinRbtn")
        self.freqTypeGroup = QtWidgets.QButtonGroup(Dialog)
        self.freqTypeGroup.setObjectName("freqTypeGroup")
        self.freqTypeGroup.addButton(self.scaleLinRbtn)
        self.horizontalLayout_4.addWidget(self.scaleLinRbtn)
        self.scaleLogRbtn = QtWidgets.QRadioButton(Dialog)
        self.scaleLogRbtn.setChecked(True)
        self.scaleLogRbtn.setObjectName("scaleLogRbtn")
        self.freqTypeGroup.addButton(self.scaleLogRbtn)
        self.horizontalLayout_4.addWidget(self.scaleLogRbtn)
        self.verticalLayout.addLayout(self.horizontalLayout_4)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.freqMinT = QtWidgets.QLineEdit(Dialog)
        self.freqMinT.setAlignment(QtCore.Qt.AlignCenter)
        self.freqMinT.setObjectName("freqMinT")
        self.horizontalLayout_5.addWidget(self.freqMinT)
        self.freqMaxT = QtWidgets.QLineEdit(Dialog)
        self.freqMaxT.setAlignment(QtCore.Qt.AlignCenter)
        self.freqMaxT.setObjectName("freqMaxT")
        self.horizontalLayout_5.addWidget(self.freqMaxT)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.scaleLinRbtn.setText(_translate("Dialog", "Lineal"))
        self.scaleLogRbtn.setText(_translate("Dialog", "Logarítmica"))
        self.freqMinT.setPlaceholderText(_translate("Dialog", "1"))
        self.freqMaxT.setPlaceholderText(_translate("Dialog", "1e7"))
